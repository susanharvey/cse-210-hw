...
class Program
{
    static void Main(string[] args)
    {
        ...
        //Initialize and set new video1, pass parameters: video title, author, length
        ...
        //Pass parameters: comment author and comment text
        ...
        //Initialize and set new video2, pass parameters: video title, author, length
        ...
        //Initialize and set new video3, pass parameters: video title, author, length
        ...
        video3._comments.Add(new Comment("Jane Mitz", "It's helful to know others struggle, too."));
        video3._comments.Add(new Comment("John Hubert", "I look forward to healing."));
 
       
 
        //Foreach loop, condition: for video in _videos
